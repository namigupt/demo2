...
@Component(
		...
		property = { 
				...
				"sling.servlet.resourceTypes=aemaacs-administration-app/components/admin/reportlist" 
				}
		)
public class ReportConfigPostServlet extends BasePostServlet {

	private static final long serialVersionUID = 986336190811585339L;
	private static final Logger log = LoggerFactory.getLogger(ReportConfigPostServlet.class);
    ...
    protected void doPost(final SlingHttpServletRequest request,
		...
		if (pageManager == null) {
			...
			try {
				...
				//spawn a job to generate content package and report
				Map<String, Object> props = new HashMap<>();
				props.putAll(valueMap);
				props.put("path", page.getPath());
				this.jobManager.addJob("com/adobe/aemaacs/jobs/content/report", props);
